...
module.exports = new (class extends controller {
  ...
  async addOrder(req, res, next) {
    ...
    try {
      ...
      return next(createError(500, "کاربر پیدا نشد، یک بار دیگر تلاش کنید"));
    }

    if (!user) {
      return next(createError(404, "کاربر یافت نشد"));
    }
    try {
      await newOrder.save();
      ...
      return next(createError(500, "تمام فیلد ها را پر کنید"));
    }
    let cart;
    try {
